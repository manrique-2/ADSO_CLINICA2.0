...
import { getIngresosByIdServer } from "@/src/app/api/ingresos/[id]/get-ingresos";
...
import FormEditarPagoTratamientoPaciente from "@/src/components/ingresos/editaringreso/formEditarPagoTratamiento";
...
export default async function EditarIngresoPage({
  ...
  try {
    ...
    const [ingresoId] = await Promise.all([
      // getTratamientosOptions(),
      getIngresosByIdServer(id),
    ]);
    ...
    if (!ingresoId) {
      return (
        <div className="p-4">
          ...
          <Link href="/dashboard/ingresos/pago-tratamientoPaciente">
      ...
      <div className="p-">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          ...
          <div className="bg-white p-6 rounded-md shadow-sm col-span-3 border-t-4 border-blue-500">
            <FormEditarPagoTratamientoPaciente
              ingreso={ingresoId}
