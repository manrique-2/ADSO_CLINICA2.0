...
import OdontoForm from "@/src/components/odontologos/odonto-form";
...
export default function RegistroOdontologo() {
  return (
    <div className="mt-3">
      <h1 className="text-xl font-medium">Registro de Odontologo</h1>
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <div className="mt-4 bg-white p-6 rounded-md shadow-sm h-fit border-t-4 border-blue-500">
          <div className="flex flex-col items-center justify-center">
            ...
            <p className="text- text-gray-500">Odontologo</p>
          </div>
          ...
          <div className="mt-6  flex justify-center">
            <Link className="w-full" href="/dashboard/registro/odontologo">
