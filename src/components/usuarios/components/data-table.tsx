    ...
    <div>
      <div className="flex items-center py-4">
        ...
        <div className="ml-auto flex gap-4">
          <Link
            href="/dashboard/gestion-usuarios/usuarios/nuevo"
      ...
      {/* esto es opcional, se puede eliminar */}
      {/* {loading && (
        <div className="mb-4 text-sm text-muted-foreground animate-pulse text-center">
          Cargando pacientes...
        </div>
      )} */}
