...
export const columns: ColumnDef<Ingresos>[] = [
  ...
  // },
  {
    ...
    // cell: ({ row }) => {
    //   const asunto = row.original.tratamientoPaciente;
    //   return asunto?.asunto ?? "—";
    // },
  },
  {
    accessorKey: "pacienteTratamiento",
    header: ({ column }) => (
      <DataTableColumnHeader column={column} title="Tratamiento del paciente" />
    ),
    // cell: ({ row }) => {
    //   const asunto = row.original.tratamientoPaciente;
    //   return asunto?.asunto ?? "—";
  ...
  // {
  //   accessorKey: "tratamientoPaciente",
  //   header: ({ column }) => (
  //     <DataTableColumnHeader column={column} title="Tratamiento del paciente" />
  //   ),
  //   cell: ({ row }) => {
  ...
  // },
  {
    accessorKey: "medico_username",
    header: ({ column }) => (
      <DataTableColumnHeader column={column} title="Odontologo(a)" />
    ),
    // cell: ({ row }) => {
    //   const medico = row.
    // }
